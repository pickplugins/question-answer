	...
	public function qa_settings_options($options = array()){
		...
		$section_options = array(
			...
			'qa_page_question_post'=>array(
				...
				'option_details'=>__('Select the page where you want to do question submission. <br>Default: N/A.', 'question-answer'),						
				'input_type'=>'select', 
			...
			'qa_page_question_archive'=>array(
				...
				'option_details'=>__('Select the page where you want to display all questions. <br>Default: N/A.', 'question-answer'),						
				'input_type'=>'select', 
				'input_args'=> $class_qa_functions->qa_get_pages(),
			),
			...
			'qa_page_myaccount'=>array(
				...
				'title'=>__('Page - Account', 'question-answer'),
				'option_details'=>__('Select the page where you want to display Account. <br>Default: N/A.', 'question-answer'),						
				'input_type'=>'select', 
				'input_args'=> $class_qa_functions->qa_get_pages(),
			),			
