	...
	public function post_type_input_fields(){
			...
			$input_fields = array(
								...
								'post_status'=>array(
														...
														'required'=>'yes',
														'placeholder'=>'',
														'title'=>__('Question Status', 'question-answer'),
														'option_details'=>__('Set the question status', 'question-answer'),					
														'input_type'=>'select',
														'input_values'=>'',
														'input_args'=> apply_filters( 'qa_filter_quesstion_status', array( 'default'=>__('Default', 'question-answer'), 'private'=>__('Private', 'question-answer') ) ),
														),															
