...
class class_qa_settings_page  {
	...
	public function qa_settings_options($options = array()){
		...
		$section_options = array(
            ...
            'qa_answer_reply_order'=>array(
                'css_class'=>'qa_answer_reply_order',
                'title'=>__('Answer reply order.', 'question-answer'),
                'option_details'=>'',
                'input_type'=>'select',
                'input_values'=> 'DESC',
                'input_args'=> array('DESC'=>'DESC', 'ASC'=>'ASC'),
            ),
		...
		$section_options = array(
            ...
            'qa_page_question_post_redirect'=>array(
                'css_class'=>'qa_page_question_post_redirect',
                'title'=>__('Page - After Question Submission', 'question-answer'),
                'option_details'=>__('Select the page where redirect after submit question.', 'question-answer'),
                'input_type'=>'select',
                'input_args'=> $class_qa_functions->qa_get_pages(),
            ),
