...
class QuestionAnswer{
	...
	public function qa_declare_classes() {
        ...
        //require_once( QA_PLUGIN_DIR . 'includes/WPAdminSettings/class-WPAdminSettings.php');
	...
	public function qa_front_scripts(){
		...
		//global
		wp_enqueue_style('fontawesome', QA_PLUGIN_URL.'assets/global/css/fontawesome.min.css');
