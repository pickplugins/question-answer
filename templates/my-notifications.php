   ...
   // $paged 		= isset( $_GET['paged'] ) ? sanitize_text_field( $_GET['paged'] ) : 1;
    ...
    echo '<div class="title">'.
         __(sprintf('Notifications <span class="count">(%s)</span>', $total_notification), 'question-answer').' 
			<span class="qa_breadcrumb_refresh">'.__('Refresh', 'question-answer').' <i class="fas fa-sync-alt"></i></span>
		</div>';
    ...
    foreach( $entries as $entry ){
	    ...
	    if( $action == 'new_question' ) {
            ...
            <div class="meta">
                ...
                <span class="notify-time"><i class="far fa-clock"></i></i> <?php echo $datetime; ?></span>
        ...
        ?>
            <div class="empty-notify"><i class="far fa-bell-slash"></i> <?php echo __('No notification right now.', 'question-answer'); ?></div>
        <?php
    endif;
