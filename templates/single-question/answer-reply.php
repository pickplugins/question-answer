                ...
                <div id="comment-<?php echo $comment->comment_ID; ?>" class="qa-single-comment single-reply">
                    ...
                    <div class="qa-comment-content">
                        ...
                        if(!empty($comment_author_user_data->display_name)):
                            ?>
                            <a href="#" class="ap-comment-author"><?php echo $comment_author_user_data->display_name; ?></a> - <a class="comment-link" href="#comment-<?php echo $comment->comment_ID; ?>"> <?php echo $comment_date; ?></a>
                            <?php
